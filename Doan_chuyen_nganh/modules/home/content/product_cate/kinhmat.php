<div class="tab-pane fade" id="sports">
    <ul class="aa-product-catg">
        <?php
            $onePerPage=4;
            $start = 0;
            $data = getProductDataByType($obj, 'KM', $start, $onePerPage);  
    ...
    <a class="aa-browse-btn" href="index.php?p=product&type=KM">Xem tất cả sản phẩm<span class="fa fa-long-arrow-right"></span></a>
</div>