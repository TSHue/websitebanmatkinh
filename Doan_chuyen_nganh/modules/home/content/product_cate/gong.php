<div class="tab-pane fade in active" id="men">
    <ul class="aa-product-catg">
        <?php
            $onePerPage=4;
            $start = 0;
            $data = getProductDataByType($obj, 'GK', $start, $onePerPage);  
    ...
    <a class="aa-browse-btn" href="index.php?p=product&type=GK">Xem tất cả sản phẩm<span class="fa fa-long-arrow-right"></span></a>
</div>